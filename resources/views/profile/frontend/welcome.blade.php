    ...
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="{{ url('/') }}#portfolio">Pengumuman</a></li>
          <li class="dropdown"><a href="#"><span>Pusat Informasi</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              ...
              <li><a href="#">Informasi Izin Usaha</a></li>
              <li><a href="{{ url('/skck') }}">Informasi SKCK</a></li>
              <li><a href="#">Informasi Biaya Nikah</a></li>
            </ul>
          </li>
      ...
      <div class="row gy-4">
        <div class="col-lg-4 col-md-6 footer-about">
          <a href="{{ url('/') }}" class="d-flex align-items-center">
            <span class="sitename">Bukit Damar</span>
          </a>
