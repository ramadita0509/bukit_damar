            ...
            <div class="card shadow-sm border-0 bg-light">
              <div class="card-body p-4">
                ...
                <ul class="mb-0">
                  ...
                  <li>Surat Keterangan Pendaftaran Penduduk Tetap bagi WNA</li> <br>
                ...
                <ul class="mb-0">
                  ...
                  <li>Khusus bagi KTP yang habis masa berlakunya dalam tahun berjalan cukup melamnpirkan KTP Asli yang sudah habis masa berakunya, Formulir Permohonan dan Surat Pengantar dari Desa diketahui Camat.</li>
